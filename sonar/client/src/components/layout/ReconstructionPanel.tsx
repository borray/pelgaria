...
const nextStages = [
  { title: 'Проектная инициатива', text: 'Единая форма обращения в Канцелярию Верховного Совета: регистрация в реестре СОНАР, сквозной номер и жизненный цикл решения.', Icon: IconFileCheck },
              ...
              <div className="renovation-dashboard">
                ...
                <aside className="renovation-release-log">
                  ...
                  <footer>
                    ...
                    <div><strong>Следующий цикл</strong><span>Проектная инициатива и реестр организаций</span></div>
                  </footer>
                </aside>
              </div>
            </div>
