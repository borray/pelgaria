...
const activeSystems = [
  { title: 'Знак Пельгарии', text: 'Проект получил собственный символ моста, ворот и северной звезды. Он встроен в публичную витрину, вкладку браузера и устанавливаемое приложение.', Icon: IconSparkles, tag: 'Готово' },
  ...
  return (
    <>
      <button className="renovation-launcher" type="button" onClick={() => setOpen(true)}>
        ...
        <span className="renovation-launcher-copy"><small>СОНАР развивается</small><strong>Реновация · цикл 10</strong></span>
            ...
            <div className="renovation-center-body">
              ...
              <div className="renovation-dashboard">
                ...
                <aside className="renovation-release-log">
                  <header><span>Журнал обновлений</span><strong>10 циклов</strong></header>
                  <div>
